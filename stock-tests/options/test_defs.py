...
from highcharts_stock.options.defs import MarkerAttributeObject as cls
from highcharts_stock.options.defs import MarkerASTNode as cls2
from highcharts_stock.options.defs import MarkerDefinition as cls3
