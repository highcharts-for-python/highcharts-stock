...
from highcharts_stock.options.plot_options.gauge import GaugeOptions as cls
from highcharts_stock.options.plot_options.gauge import SolidGaugeOptions as cls2
