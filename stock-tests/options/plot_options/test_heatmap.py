...
from highcharts_stock.options.plot_options.heatmap import HeatmapOptions as cls
from highcharts_stock.options.plot_options.heatmap import TilemapOptions as cls2
