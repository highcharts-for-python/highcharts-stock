...
from highcharts_stock.options.plot_options.funnel import FunnelOptions as cls
from highcharts_stock.options.plot_options.funnel import Funnel3DOptions as cls2
