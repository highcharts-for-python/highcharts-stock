...
from highcharts_stock.global_options.language.navigation import NavigationLanguageOptions as cls
from highcharts_stock.global_options.language.navigation import PopupLanguageOptions as cls2
