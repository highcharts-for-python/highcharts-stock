...
from highcharts_stock.options.series.base import IndicatorSeriesBase, NavigatorIndicatorSeries
from highcharts_stock.options.plot_options.abands import AbandsOptions, BBOptions


class AbandsSeries(IndicatorSeriesBase, AbandsOptions):
...
class KeltnerChannelsSeries(AbandsSeries):
...
class BBSeries(NavigatorIndicatorSeries, BBOptions):
