...
class DEMASeries(IndicatorSeriesBase, DEMAOptions):
...
class EMASeries(NavigatorIndicatorSeries, EMAOptions):
...
class SMASeries(NavigatorIndicatorSeries, SMAOptions):
...
class TEMASeries(IndicatorSeriesBase, TEMAOptions):
...
class VWAPSeries(NavigatorIndicatorSeries, VWAPOptions):
...
class WMASeries(NavigatorIndicatorSeries, WMAOptions):
