...
class PolygonSeries(SeriesBase, PolygonOptions):
    """Options to configure a Polygon series.
    ...
    def data(self) -> Optional[List[CartesianData] | CartesianDataCollection]:
        ...
        .. tabs::
          ...
          .. tab:: 1D Collection
            ...
            If :meth:`PolygonSeries.point_start` is :obj:`None <python:None>`, ``x``
            values will begin at ``0``. Otherwise, they will start at ``point_start``.

            If :meth:`PolygonSeries.point_interval` is :obj:`None <python:None>`, ``x``
