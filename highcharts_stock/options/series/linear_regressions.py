...
class LinearRegressionSeries(NavigatorIndicatorSeries, LinearRegressionOptions):
...
class LinearRegressionAngleSeries(NavigatorIndicatorSeries, LinearRegressionAngleOptions):
...
class LinearRegressionInterceptSeries(NavigatorIndicatorSeries, LinearRegressionInterceptOptions):
...
class LinearRegressionSlopeSeries(NavigatorIndicatorSeries, LinearRegressionSlopeOptions):
...
class TrendlineSeries(NavigatorIndicatorSeries, TrendlineOptions):
