...
from highcharts_stock.options.series.data.vector import VectorData, VectorDataCollection
...
class VectorSeries(SeriesBase, VectorOptions):
    """Options to configure a Vector series.
    ...
    def data(self) -> Optional[List[VectorData] | VectorDataCollection]:
        ...
        While the series type returns a collection of :class:`VectorData` instances,
        ...
        .. tabs::
          ...
          .. tab:: 4D Collection
            ...
            A collection of four-dimensional numerical values. Each member of the
            collection will be interpreted as :meth:`x <VectorData.x>`,
            :meth:`y <VectorData.y>`, :meth:`length <VectorData.length>`, and
            :meth:`direction <VectorData.direction>`, respectively.
