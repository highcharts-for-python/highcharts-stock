from highcharts_python.options.plot_options.wordcloud import (RotationOptions,
                                                              WordcloudOptions as WordcloudBase)
...
class WordcloudOptions(WordcloudBase, NonIndicatorOptions):
