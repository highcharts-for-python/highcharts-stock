...
class HLCOptions(BaseBarOptions, NonIndicatorOptions):
    ...
    def up_line_color(self) -> Optional[str | Gradient | Pattern]:
        ...
        :meth:`.line_color <highcharts_stock.options.plot_options.hlc.HLCOptions.line_color>`
        setting. Defaults to ``'#06b535'``.
    ...
    def _get_kwargs_from_dict(cls, as_dict):
        kwargs = {
            ...
            # Commenting out properties that are ignored in HLC charts but which
            # are inherited.
