from highcharts_python.options.plot_options.packedbubble import (ParentNodeOptions,
                                                                 PackedBubbleOptions as PackedBubbleBase)
...
class PackedBubbleOptions(PackedBubbleBase, NonIndicatorOptions):
