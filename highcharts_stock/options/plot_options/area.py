...
class AreaOptions(AreaBase, NonIndicatorOptions):
...
class LineOptions(LineBase, NonIndicatorOptions):
    ...
    def use_ohlc_data(self) -> Optional[bool]:
        ...
        .. caution::
          ...
          Data in OHLC-format is required for this to function properly if set to
          ``True``.

        :rtype: :class:`bool <python:bool>` or :obj:`None <python:None>`
        """
        return self._use_ohlc_data

    @use_ohlc_data.setter
    def use_ohlc_data(self, value):
        if value is None:
            self._use_ohlc_data = None
        else:
            self._use_ohlc_data = bool(value)
    ...
    def _get_kwargs_from_dict(cls, as_dict):
        kwargs = {
            ...
            'use_ohlc_data': as_dict.get('uesOhlcData', None),
    ...
    def _to_untrimmed_dict(self, in_cls = None) -> dict:
        untrimmed = {
            'useOhlcData': self.use_ohlc_data,
        }
