from highcharts_python.options.plot_options.pie import (PieOptions as PieBase,
                                                        VariablePieOptions as VariablePieBase)
...
class PieOptions(PieBase, NonIndicatorOptions):
...
class VariablePieOptions(VariablePieBase, NonIndicatorOptions):
