from highcharts_python.options.plot_options.bellcurve import BellCurveOptions as BellCurveBase
...
class BellCurveOptions(BellCurveBase, NonIndicatorOptions):
