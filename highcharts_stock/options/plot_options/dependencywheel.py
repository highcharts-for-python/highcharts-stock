from highcharts_python.options.plot_options.dependencywheel import DependencyWheelOptions as DependencyWheelBase
...
class DependencyWheelOptions(DependencyWheelBase, NonIndicatorOptions):
