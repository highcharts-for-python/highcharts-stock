...
class AbandsOptions(IndicatorOptions):
    """:term:`Acceleration Bands`, which plot a trio of lines using a simple moving
    average for the midpoint, and the high and low values as the high and low bands."""
