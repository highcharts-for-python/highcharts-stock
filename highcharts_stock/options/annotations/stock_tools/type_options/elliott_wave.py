...
from highcharts_stock.options.annotations.stock_tools.type_options.points import LabeledStockToolsPoint


class ElliottWaveTypeOptions(HighchartsMeta):
    ...
    @property
    def points(self) -> Optional[List[LabeledStockToolsPoint]]:
    ...
    @points.setter
    @class_sensitive(LabeledStockToolsPoint, force_iterable = True)
