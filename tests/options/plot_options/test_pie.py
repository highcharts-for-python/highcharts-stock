...
from highcharts_stock.options.plot_options.pie import PieOptions as cls
from highcharts_stock.options.plot_options.pie import VariablePieOptions as cls2
