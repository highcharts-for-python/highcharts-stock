...
from highcharts_stock.options.series.sunburst import SunburstSeries as cls
...
@pytest.mark.parametrize('filename, as_file, error', [
    ('series/sunburst/01.js', False, None),
    ('series/sunburst/02.js', False, None),

    ('series/sunburst/error-01.js',
     False,
    ...
    ('series/sunburst/01.js', True, None),
    ('series/sunburst/02.js', True, None),
