...
from highcharts_stock.options.plot_options.oscillators.stochastic import StochasticOptions as cls
from highcharts_stock.options.plot_options.oscillators.stochastic import SlowStochasticOptions as cls2
