...
from highcharts_stock.global_options.language.accessibility.series import SeriesTypeDescriptions as cls
from highcharts_stock.global_options.language.accessibility.series import SeriesLanguageOptions as cls2
