#############################################################################
:mod:`.oscillators <highcharts_stock.options.plot_options.oscillators>`
#############################################################################
...
********************************************************************************************************************
class: :class:`AroonOscillatorOptions <highcharts_stock.options.plot_options.oscillators.AroonOscillatorOptions>`
********************************************************************************************************************

.. autoclass:: AroonOscillatorOptions
  :members:
  :inherited-members:
