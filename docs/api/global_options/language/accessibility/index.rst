###################################################################################
:mod:`.accessibility <highcharts_stock.global_options.language.accessibility>`
###################################################################################
...
.. module:: highcharts_stock.global_options.language.accessibility

****************************************************************************************************************************************
class: :class:`AccessibilityLanguageOptions <highcharts_stock.global_options.language.accessibility.AccessibilityLanguageOptions>`
****************************************************************************************************************************************
