#################################################################
:mod:`.language <highcharts_stock.global_options.language>`
#################################################################
...
.. module:: highcharts_stock.global_options.language

******************************************************************************************
class: :class:`Language <highcharts_stock.global_options.language.Language>`
******************************************************************************************
