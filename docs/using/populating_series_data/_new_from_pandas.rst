  .. note::
    ...
    :class:`Chart <highcharts_stock.chart.Chart>` class, allowing you to either assemble
...
.. collapse:: Method Signature
  ...
  .. seealso::
    ...
    * :meth:`Chart.from_pandas() <highcharts_stock.chart.Chart.from_pandas>`
    * :meth:`Chart.from_pandas_in_rows() <highcharts_stock.chart.Chart.from_pandas_in_rows>`
    * :meth:`SeriesBase.from_pandas_in_rows() <highcharts_stock.options.series.base.SeriesBase.from_pandas_in_rows>`
  ...
  .. method:: .from_pandas(cls, df, property_map = None, series_kwargs = None, series_in_rows = False, series_index = None, **kwargs)
    ...
    :meth:`.data <highcharts_stock.options.series.base.SeriesBase.data>` properties
    ...
    :param series_type: Indicates the series type that should be created from the CSV
      ...
      .. warning::
        ...
        :meth:`.from_pandas() <highcharts_stock.options.series.base.SeriesBase.from_pandas>` on 
        a :term:`series`. It is only supported when calling 
        :meth:`Chart.from_csv() <highcharts_stock.chart.Chart.from_pandas>`.
    ...
    :returns: One or more :term:`series` instances (descended from
      :class:`SeriesBase <highcharts_stock.options.series.base.SeriesBase>`) with the
    ...
    :rtype: :class:`list <python:list>` of series instances (descended from
      ...
      a :class:`SeriesBase <highcharts_stock.options.series.base.SeriesBase>`-descended
      instance
